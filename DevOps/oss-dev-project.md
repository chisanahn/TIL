...
2020-1 Git/GitHub 특강에서 강사님께서 추천해주신 블로그 https://42place.innovationacademy.kr/archives/5685

[CI Tool 비교](https://elfinlas.github.io/2019/08/14/ci-tool/)

오픈소스개발프로젝트 때 수정사항이 생길때마다 수작업으로 배포하는게 되게 번거로웠다. aws ec2 용량이 부족해서 docker-compose도 못쓰고..

AWS 용량 제한 때문에 사용이 안될거같기도 하지만 
